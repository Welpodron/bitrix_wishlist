			...
			<div id="basket_form_container">
				<div class="bx_ordercart <?=$templateData['TEMPLATE_CLASS'];?>">
					<div class="bx_sort_container">
						<a href="javascript:void(0)" id="basket_toolbar_button" class="<?=($_REQUEST['wishlist'] && $delayCount > 0 ? '' : 'current')?>" onclick="showBasketItemsList()"><?=GetMessage('SALE_BASKET_ITEMS')?><div id="normal_count" class="flat" style="display:none">&nbsp;(<?=$normalCount?>)</div></a>
						<a href="javascript:void(0)" id="basket_toolbar_button_delayed" class="<?=($_REQUEST['wishlist'] && $delayCount > 0 ? 'current' : '')?>" onclick="showBasketItemsList(2)" <?=$delayHidden?>><?=GetMessage('SALE_BASKET_ITEMS_DELAYED')?><div id="delay_count" class="flat">&nbsp;(<?=$delayCount?>)</div></a>
